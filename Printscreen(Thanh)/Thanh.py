...
class SearchBar:
    ...
    def create_gui(self):
        ...
        self.text_label = tk.Label(self.master, text="", textvariable=self.text_var,
                                   font=("Helvetica", 36, 'bold'), bg="#222121", fg="#CCCC00",  # Đổi màu chữ và độ đậm
    ...
    def chao(self):
        try:
            ...
            if 5 <= current_hour < 12:
                greeting = f"Chào buổi sáng, cậu chủ Thành🤗✨(～￣▽￣)～   {random.choice(self.emoticons)}"
            elif 12 <= current_hour < 18:
                greeting = f"Chào buổi chiều, cậu chủ Thành🤗✨(～￣▽￣)～   {random.choice(self.emoticons)}"
            else:
                greeting = f"Chào buổi tối, cậu chủ Thành🤗✨(～￣▽￣)～   {random.choice(self.emoticons)}"
    ...
    def get_sentence_from_db(self):
        try:
            ...
            c.execute('''
                                ...
                                FROM sentences
                                ORDER BY CAST(times AS INTEGER) ASC
    ...
    def chay(self):
        print("chay(self)")
        self.say()
        self.master.after(2040000, self.chay)  # 2040 giây là 34 phút
